            ...
            <div className="qualification__sections">
                <div className={toggleState === 1 ? "qualification__content qualification__content-active" : "qualification__content"}>
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                            <h3 className="qualification__title">Zero to Pro CS Bootcamp(Level-4 + Level-3)</h3>
                            <span className='qualification__subtitle'>Myanmar IT Bootcamp</span>
                            <div className='qualification__calendar'>
                    ...
                    <div className="qualification__data">
                        <div>
                            <h3 className="qualification__title">PHP and Laravel Bootcamp</h3>
                            <span className='qualification__subtitle'>Host Myanmar Mandalay</span>
                            <div className='qualification__calendar'>
                ...
                <div className={toggleState === 2 ? "qualification__content qualification__content-active" : "qualification__content"}>
                    <div className="qualification__data">
                        <div>
                            <h3 className="qualification__title">PHP, Laravel On Job Training</h3>
                            <span className='qualification__subtitle'>Host Myanmar Mandalay</span>
                            <div className='qualification__calendar'>
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                            <h3 className="qualification__title">Laravel Developer (Internship)</h3>
                            <span className='qualification__subtitle'>Host Myanmar IT Solution</span>
                            <div className='qualification__calendar'>
                    ...
                    <div className="qualification__data">
                        <div>
                            <h3 className="qualification__title">Junior Backend Developer</h3>
